	...
	<?php } else if (!empty($tanggal) && !empty($result)) { ?>
		...
		<h4>Laporan Harian</h4>
		<div class="btn-group">
	<a class="btn btn-warning btn-sm" href="<?php echo base_url().'p/laporan_harian_pdf/?tanggal='.set_value('tanggal') ?>"><span class="glyphicon glyphicon-print"></span> Cetak PDF</a>	
	<a class="btn btn-default btn-sm" href="<?php echo base_url().'p/laporan_harian_print/?tanggal='.set_value('tanggal') ?>"><span class="glyphicon glyphicon-print"></span> Print</a>	
</div>
<br><br/>
