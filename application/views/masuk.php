...
<table class="table table-bordered table-hover table-striped" id="table-datatable">
	...
	<?php foreach ($result as $data) { ?>
		<tr>
			...
			<td>
				<a class="btn btn-sm btn-warning" href="<?=base_url('p/ubah_pemasukan/'.$data->nomor);?>"><span class="glyphicon glyphicon-wrench">Ubah</span></a> &nbsp; 
				<a class="btn btn-sm btn-danger" href="<?=base_url('p/hapus_pemasukan/'.$data->nomor);?>"><span class="glyphicon glyphicon-trash">Hapus</span></a>
			</td>
		</tr>
	<?php } ?>
	</tbody>
